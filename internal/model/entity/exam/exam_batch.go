...
type ExamBatch struct {
	...
	MockExaminationPaperId int64       `json:"mock_examination_paper_id" orm:"mock_examination_paper_id" description:"mock 卷 id，与 exam_paper 业务主键一致"` // mock 卷 id，与 exam_paper 业务主键一致
