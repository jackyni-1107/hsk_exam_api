...
type SysNotificationTemplate struct {
	...
	ChannelConfigId          int64       `json:"channel_config_id"           orm:"channel_config_id"           description:"绑定的通知渠道配置ID（sys_notification_channel_config.id）"` // 绑定的通知渠道配置ID（sys_notification_channel_config.id）
	TemplateType             int         `json:"template_type"               orm:"template_type"               description:"模板类型：1=系统模板 2=第三方模板"`                             // 模板类型：1=系统模板 2=第三方模板
	Content                  string      `json:"content"                     orm:"content"                     description:"模板内容，支持变量 {{var}}"`                               // 模板内容，支持变量 {{var}}
	ThirdPartyTemplateId     string      `json:"third_party_template_id"     orm:"third_party_template_id"     description:"第三方模板ID"`                                         // 第三方模板ID
	ThirdPartyTemplateParams string      `json:"third_party_template_params" orm:"third_party_template_params" description:"第三方模板参数(JSON)"`                                   // 第三方模板参数(JSON)
