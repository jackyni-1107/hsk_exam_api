...
export interface TemplateItem {
  ...
  content: string;
  third_party_template_id: string;
  third_party_template_params: string;
  variables: string;
  status: number;
  create_time: string;
}
...
export function fetchNotificationLogs(params: {
  ...
  return request.get<
    unknown,
    { data?: { list?: NotificationLogItem[]; total?: number } }
  >("/admin/notification/log/list", { params });
}

export function fetchChannelConfigs(params?: { channel?: string }) {
  return request.get<unknown, { data?: { list?: ChannelConfigItem[] } }>(
    "/admin/notification/channel/list",
    {
      params,
    },
  );
...
export function createChannelConfig(payload: {
  ...
  return request.post<unknown, { data?: { id?: number } }>(
...
export function updateChannelConfig(
  ...
  return request.put<unknown, unknown>(
...
export function setActiveChannelConfig(id: number) {
  return request.post<unknown, unknown>(
    `/admin/notification/channel/${id}/set-active`,
  );
}
...
export function fetchTemplates(params: {
  ...
  return request.get<
    unknown,
    { data?: { list?: TemplateItem[]; total?: number } }
  >("/admin/notification/template/list", { params });
}
...
export function sendNotification(payload: {
  ...
  return request.post<unknown, { data?: { ok?: boolean } }>(
